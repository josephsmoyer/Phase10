    ...
    protected void receiveInfo(GameInfo info){
        ...
        if (savedState.getToPlay() == this.playerNum) {
            ...
            if(savedState.getShouldDraw()){
                ...
                myAction = new P10DrawCardAction(this, true);
            }  //dumb player always draws from draw pile unless that card is a wild
                ...
                if(myAction == null){   //if didnt make phase or hit
                    ...
                    if(c.getWildValue() ==  14){
                        //if its a skip card
                        c.setSkipValue(generateToSkip()); //set the skip information
                    }
